...
public class Listac extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        clientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nombre", "Apellido", "Dirección", "Dni o Ruc", "Teléfono", "Correo "
            }
        ) {
        ...
        if (clientes.getColumnModel().getColumnCount() > 0) {
            clientes.getColumnModel().getColumn(3).setPreferredWidth(200);
            clientes.getColumnModel().getColumn(6).setResizable(false);
            clientes.getColumnModel().getColumn(6).setPreferredWidth(200);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         try {
            ...
            ps = (PreparedStatement) con.prepareStatement("select idcliente,Nombre,Apellido,Direccion,Dni,Telefono,Correo from cliente");
